...
export type FeaturedUserQueryVariables = Exact<{
  login: Scalars['String'];
}>;


export type FeaturedUserQuery = { user: { contributionsCollection: { pullRequestContributions: { edges: Array<{ node: { pullRequest: { title: string, url: any, bodyHTML: any, number: number, state: PullRequestState, labels: { nodes: Array<{ name: string, color: string, description: string }> }, repository: { description: string, nameWithOwner: string, url: any, stargazerCount: number, forkCount: number } } } }> } }, repositories: { edges: Array<{ node: { name: string, url: any, description: string, stargazerCount: number, forkCount: number, languages: { edges: Array<{ node: { name: string, color: string } }> } } }> }, pinnedItems: { edges: Array<{ node: { name: string, url: any, description: string, stargazerCount: number } | { name: string, url: any, description: string, stargazerCount: number, forkCount: number, languages: { edges: Array<{ node: { name: string, color: string } }> } } }> } } };

export type RecentFollowersQueryVariables = Exact<{
  login: Scalars['String'];
}>;


export type RecentFollowersQuery = { user: { followers: { nodes: Array<{ login: string, id: string, bioHTML: any, company: string, location: string, name: string, websiteUrl: any, twitterUsername: string, avatar_url: any, followers: { totalCount: number }, status: { emojiHTML: any, message: string } }> } } };

export type RecentFollowingQueryVariables = Exact<{
  login: Scalars['String'];
}>;


export type RecentFollowingQuery = { user: { following: { totalCount: number, nodes: Array<{ login: string, id: string, bioHTML: any, company: string, location: string, name: string, websiteUrl: any, twitterUsername: string, avatar_url: any, followers: { totalCount: number }, status: { emojiHTML: any, message: string } }> } } };

export type RepoDescriptionQueryVariables = Exact<{
  owner: Scalars['String'];
  name: Scalars['String'];
}>;


export type RepoDescriptionQuery = { repository: { name: string, description: string, url: any, updatedAt: any, languages: { edges: Array<{ node: { color: string, name: string } }> }, stargazers: { totalCount: number } } };

export type SuggestedUsersQueryVariables = Exact<{ [key: string]: never; }>;


export type SuggestedUsersQuery = { sindresorhus: { login: string, id: string, bioHTML: any, company: string, location: string, name: string, websiteUrl: any, twitterUsername: string, avatar_url: any, followers: { totalCount: number }, status: { emojiHTML: any, message: string } }, emmabostian: { login: string, id: string, bioHTML: any, company: string, location: string, name: string, websiteUrl: any, twitterUsername: string, avatar_url: any, followers: { totalCount: number }, status: { emojiHTML: any, message: string } }, rauchg: { login: string, id: string, bioHTML: any, company: string, location: string, name: string, websiteUrl: any, twitterUsername: string, avatar_url: any, followers: { totalCount: number }, status: { emojiHTML: any, message: string } } };
