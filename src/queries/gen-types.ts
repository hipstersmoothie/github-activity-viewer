...
export type FeaturedUserQueryVariables = Exact<{ [key: string]: never; }>;


export type FeaturedUserQuery = { user: Maybe<{ contributionsCollection: { pullRequestContributions: { edges: Maybe<Array<Maybe<{ node: Maybe<{ pullRequest: (
              Pick<PullRequest, 'title' | 'url' | 'bodyHTML' | 'number' | 'state'>
              & { labels: Maybe<{ nodes: Maybe<Array<Maybe<Pick<Label, 'name' | 'color' | 'description'>>>> }>, repository: Pick<Repository, 'description' | 'nameWithOwner' | 'url' | 'stargazerCount' | 'forkCount'> }
            ) }> }>>> } }, repositories: { edges: Maybe<Array<Maybe<{ node: Maybe<(
          Pick<Repository, 'name' | 'url' | 'description' | 'stargazerCount' | 'forkCount'>
          & { languages: Maybe<{ edges: Maybe<Array<Maybe<{ node: Pick<Language, 'name' | 'color'> }>>> }> }
        )> }>>> }, pinnedItems: { edges: Maybe<Array<Maybe<{ node: Maybe<Pick<Gist, 'name' | 'url' | 'description' | 'stargazerCount'> | (
          Pick<Repository, 'name' | 'url' | 'description' | 'stargazerCount' | 'forkCount'>
          & { languages: Maybe<{ edges: Maybe<Array<Maybe<{ node: Pick<Language, 'name' | 'color'> }>>> }> }
        )> }>>> } }> };

export type RecentFollowersQueryVariables = Exact<{ [key: string]: never; }>;


export type RecentFollowersQuery = { user: Maybe<{ followers: { nodes: Maybe<Array<Maybe<(
        Pick<User, 'login' | 'id' | 'bioHTML' | 'company' | 'location' | 'name' | 'websiteUrl' | 'twitterUsername'>
        & { avatar_url: User['avatarUrl'] }
        & { followers: Pick<FollowerConnection, 'totalCount'>, status: Maybe<Pick<UserStatus, 'emojiHTML' | 'message'>> }
      )>>> } }> };

export type RecentFollowingQueryVariables = Exact<{ [key: string]: never; }>;


export type RecentFollowingQuery = { user: Maybe<{ following: (
...
export type RepoDescriptionQueryVariables = Exact<{ [key: string]: never; }>;


export type RepoDescriptionQuery = { repository: Maybe<(
    Pick<Repository, 'name' | 'description' | 'url' | 'updatedAt'>
    & { languages: Maybe<{ edges: Maybe<Array<Maybe<{ node: Pick<Language, 'color' | 'name'> }>>> }>, stargazers: Pick<StargazerConnection, 'totalCount'> }
  )> };

export type SuggestedUsersQueryVariables = Exact<{ [key: string]: never; }>;


export type SuggestedUsersQuery = { sindresorhus: Maybe<(
    Pick<User, 'login' | 'id' | 'bioHTML' | 'company' | 'location' | 'name' | 'websiteUrl' | 'twitterUsername'>
    & { avatar_url: User['avatarUrl'] }
    & { followers: Pick<FollowerConnection, 'totalCount'>, status: Maybe<Pick<UserStatus, 'emojiHTML' | 'message'>> }
  )>, emmabostian: Maybe<(
