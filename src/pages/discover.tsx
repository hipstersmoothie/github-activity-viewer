...
import PopperPopover from "../components/Popover";
...
const App = () => {
  const { trendingInNetwork } = useTrendingFollowers();

  console.log(trendingInNetwork);
              ...
              {trendingUser.twitterUsername && (
                ...
                >
                  <Link
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href={`https://twitter.com/${trendingUser.twitterUsername}`}
                  >
                    {trendingUser.twitterUsername}
                  </Link>
                </DataIcon>
